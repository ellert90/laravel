...
Route::get('/contact/all/{id}/update', 'App\Http\Controllers\ContactController@updateMessage')->name('contact-data-update');
...
// Route::get('/my', 'App\Http\Controllers\MyPlaceController@test');
// Route::get('/my', [MyPlaceController::class, 'test']);
// [UsersController::class, 'showOne']
